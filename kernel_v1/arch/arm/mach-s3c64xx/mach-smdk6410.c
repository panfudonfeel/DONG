...
/* MMC/SD config */
static struct s3c_sdhci_platdata qt6410_hsmmc0_pdata = {
    .max_width      = 4,
    .cd_type        = S3C_SDHCI_CD_INTERNAL,
};

static struct s3c_sdhci_platdata qt6410_hsmmc1_pdata = {
    .max_width      = 4,
...
//jkeqiang	
	...
	s3c_sdhci0_set_platdata(&qt6410_hsmmc0_pdata);
	s3c_sdhci1_set_platdata(&qt6410_hsmmc1_pdata);
