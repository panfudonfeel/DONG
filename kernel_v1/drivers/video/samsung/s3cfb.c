...
static int __init setlcdsize(char *str)
{
printk("call setlcdsize %s",str);
	if(strcmp(str,"35")==0)
		lcdsize = 0;
	else if(strcmp(str,"43")==0)
		lcdsize = 1;
	else if(strcmp(str,"56")==0)
		lcdsize = 2;
	else if(strcmp(str,"70")==0)
		lcdsize = 3;
	else if(strcmp(str,"VGA800")==0)
		lcdsize = 4;
	else
		lcdsize = 1;
	return 1;
}
__setup("lcdsize=", setlcdsize);
